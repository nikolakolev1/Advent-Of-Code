...
public class Day10_Other {
    ...
    public static void main(String... args) throws Exception {
        Day10_Other day10 = new Day10_Other();
        File input = new File("data/Day10/input.txt");
        ...
        System.out.println(day10.runPart1(inputList));
        System.out.println(day10.runPart2(inputList));
    }
}